...
| [x] | P10-T2 | Document full CLI workflow | codex | P10-T1 | `README.md`, `docs/plans/boards/README.md` | docs self-check + command copy/paste check | `<pending>` | Started 2026-03-04 16:04 CST; documented workflow matrix and validated all documented command variants via copy/paste |
