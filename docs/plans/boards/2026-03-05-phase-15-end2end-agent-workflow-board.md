...
**Last Updated:** `2026-03-05 18:37 CST`
...
| [~] | P15-T5 | Implement core `generate-ui` workflow with warning/trace guarantees | codex | P15-T4 | `crates/core/src/lib.rs`, `crates/core/src/tests.rs` | `cargo test -p specloom-core generate_ui_in_workspace_always_emits_warning_and_trace_artifacts` | - | Started 2026-03-05 18:37 CST |
