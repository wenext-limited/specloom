...
**Last Updated:** `2026-03-05 18:27 CST`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [~] | P15-T1 | Add `llm_bundle` contract types in core | codex | - | `crates/core/src/llm_bundle.rs`, `crates/core/src/lib.rs` | `cargo test -p specloom-core llm_bundle_round_trip_json llm_bundle_contract_version_is_explicit` | - | Started 2026-03-05 18:27 CST |
| [ ] | P15-T2 | Implement deterministic bundle builder and artifact hashing | unassigned | P15-T1 | `crates/core/src/lib.rs`, `crates/core/src/tests.rs`, `crates/core/src/hash.rs`, `crates/core/src/llm_bundle.rs` | `cargo test -p specloom-core prepare_llm_bundle_in_workspace_writes_bundle_artifact` | - | |
