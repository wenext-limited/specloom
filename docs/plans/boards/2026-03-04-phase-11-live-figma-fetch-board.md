...
| [~] | P11-T5 | Harden orchestrator live fetch actionable errors | codex | P11-T4 | `crates/orchestrator/src/lib.rs` | `cargo test -p orchestrator` | - | Started 2026-03-04 16:40 CST; improving actionable guidance for live fetch auth and parameter failures |
