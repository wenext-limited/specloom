...
| [x] | P11-T3 | Add live transport tests with mock server | codex | P11-T2 | `crates/figma_client/Cargo.toml`, `crates/figma_client/src/lib.rs` | `cargo test -p figma_client` | `<pending>` | Started 2026-03-04 16:36 CST; added mock HTTP transport tests for auth header, path/query, success, and status mapping |
