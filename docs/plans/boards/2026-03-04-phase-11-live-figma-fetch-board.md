...
**Last Updated:** `2026-03-04 16:41 CST`
...
| [~] | P11-T6 | Expose live fetch options in CLI | codex | P11-T5 | `crates/cli/src/main.rs`, `crates/cli/tests/commands.rs`, `crates/cli/tests/integration_smoke.rs` | `cargo test -p cli` | - | Started 2026-03-04 16:41 CST; adding live input options and config handoff for `fetch`/`generate` |
