...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [x] | P11-T1 | Add live fetch request/auth contracts | codex | - | `crates/figma_client/src/lib.rs`, `crates/figma_client/Cargo.toml` | `cargo test -p figma_client` | `<pending>` | Started 2026-03-04 16:32 CST; added live request/auth contract types and explicit live fetch error variants |
