...
| [~] | P13-T7 | Expose orchestrator lookup tool APIs (`find_nodes`, `get_node_info`) | codex | P13-T6 | `crates/orchestrator/src/lib.rs` | `cargo test -p orchestrator` | - | Started 2026-03-05 03:31 CST |
