...
**Last Updated:** `2026-03-05 03:22 CST`
...
| [~] | P13-T3 | Add JSON contracts for agent context, search index, warnings, and trace | codex | P13-T2 | `crates/agent_context/src/lib.rs` | `cargo test -p agent_context` | - | Started 2026-03-05 03:23 CST |
