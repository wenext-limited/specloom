...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [~] | P12-T1 | Create `ui_blueprint` crate with core YAML contract types | codex | - | `Cargo.toml`, `crates/ui_blueprint/Cargo.toml`, `crates/ui_blueprint/src/lib.rs` | `cargo test -p ui_blueprint` | - | Started 2026-03-04 17:55 CST; implementing core types and round-trip tests |
