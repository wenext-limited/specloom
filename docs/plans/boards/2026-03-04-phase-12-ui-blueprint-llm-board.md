...
**Last Updated:** `2026-03-04 17:56 CST`
...
| [~] | P12-T2 | Implement `ui_spec -> ui_blueprint` mapper with semantic layout names | codex | P12-T1 | `crates/ui_blueprint/Cargo.toml`, `crates/ui_blueprint/src/lib.rs` | `cargo test -p ui_blueprint build_blueprint_from_ui_spec_maps_root_layout_and_warnings -- --nocapture && cargo test -p ui_blueprint` | - | Started 2026-03-04 17:57 CST; wiring `ui_spec` conversion and semantic layout mapping |
